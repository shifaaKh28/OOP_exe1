...
public class Comparators {
    ...
    /**
     * Sets the winner to be used in comparators that depend on the winner's information.
     *
     * @param winner The ConcretePlayer object representing the winner.
     */
    ...
    /**
     * Comparator for sorting ConcretePiece objects based on the number of steps taken in their history.
     */
    ...
    /**
     * Comparator for sorting ConcretePiece objects based on the number of kills, with tie-breakers
     * for owner and piece ID.
     */
    ...
    /**
     * Comparator for sorting ConcretePiece objects based on the distance traveled, with tie-breakers
     * for owner and piece ID.
     */
    ...
    /**
     * Comparator for sorting Map entries (Position and Set of ConcretePiece) based on the number
     * of pieces on a position, with tie-breakers for X-coordinate and size of the piece set.
     */
