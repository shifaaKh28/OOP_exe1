...
public class GameLogic implements PlayableLogic {
    ...
    //Stack to store the history of moves for undo functionality.
    private Stack<MoveSnapshot> boardHistory;

    // Flag indicating whether the game has finished.
    private boolean isFinished;

     //Flag indicating whether it is the attacker's turn.
    private boolean attackerTurn = true;

     // The number of attacker pieces killed.
    private int attackerKilled;

    /**
     * The last pawn that made a killing move.
     */
    ...
    public boolean move(Position a, Position b) {
        ...
        // Update the piece's position history if it's the first move
        ...
        // Check for capturing moves and update the last killing pawn
        checkMove(b);
